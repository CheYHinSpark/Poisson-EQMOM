...
while( tmoment<tsp - 1e-6 )
    ...
    for i = 1:nX
        ...
        flux_Y(:,1,i) = 2 * real( F_int_d(3:N+3,1,i) - F_int_d(1:N+1,1,i) );
        flux_Y(:,nY+1,i) = 2 * real( F_int_u(3:N+3,nY,i) - F_int_u(1:N+1,nY,i) );
    end
...
name = strcat(datestr(datetime,'yyyymmdd'), "_Vortex_N", num2str(N), "_X", num2str(nX), ".mat");
save(name);
